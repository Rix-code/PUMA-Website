...
<template>
  <div
    class="flex items-center justify-center min-h-screen px-4 py-12 bg-white sm:px-6"
  >
    <div
      class="w-full max-w-6xl mx-auto overflow-hidden bg-white border border-gray-200 shadow-xl rounded-3xl"
    >
      <div class="flex flex-col md:flex-row">
        ...
        >
          <div class="max-w-md mx-auto md:mx-0">
            <div class="relative mb-12">
              ...
              ></div>
              <div
                class="absolute right-0 w-24 h-24 bg-gray-200 rounded-full top-20 opacity-30 blur-lg"
              ></div>
              ...
              <p class="relative z-10 mb-8 text-lg text-gray-800">
                ...
                Distinctio quaerat facere quam perspiciatis laboriosam corporis
                maxime optio, exercitationem maiores dicta tempore, cum eligendi
                repellendus, minima aperiam tempora quibusdam ut hic.
              </p>
        ...
        <div
          class="w-full overflow-y-auto bg-white md:w-3/5"
          style="max-height: 80vh"
        >
          <div class="p-8 md:p-12">
            <h2 class="mb-8 text-3xl font-bold text-gray-800 md:hidden">
              Top Stories
            </h2>
