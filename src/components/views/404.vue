    ...
    <main class="flex items-center justify-center flex-1 w-full px-4">
      <div class="w-full max-w-4xl">
        <div class="text-center">
          <div class="relative">
            <h1 
              class="font-mono text-9xl font-bold tracking-tighter text-white md:text-[12rem]"
          ...
          <div 
            class="px-3 py-1 mx-auto -mt-4 font-mono text-xs tracking-wider text-white uppercase bg-white/10 w-fit rounded-xl"
          ...
          <div class="flex flex-col items-center justify-center w-full max-w-xs mx-auto mt-6 font-mono">
            <div v-if="isCountdownActive" class="w-full p-4 mb-4 text-xs text-left text-white rounded-lg bg-white/5">
              ...
              <div class="w-full h-1 overflow-hidden rounded-full bg-white/10">
                <div 
                  class="h-full transition-all duration-1000 bg-white"
