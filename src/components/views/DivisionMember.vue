...
const divisions: Division[] = [
  { name: 'BOD', title: 'Board of Directors', image: '/division/bod.JPG', description: 'Strategic leadership and organizational governance, overseeing all major decisions and future planning for the organization.' },
  { name: 'RNT', title: 'Research and Technology', image: 'https://i.pinimg.com/736x/f2/96/65/f296659f98543ad0ee11738a62e7652f.jpg', description: 'Focuses on innovation, technological advancements, and exploring new tools to enhance organizational capabilities.' },
  { name: 'HRD', title: 'Human Resources Development', image: '/division/hrd.JPG', description: 'Dedicated to talent acquisition, member development, training programs, and fostering a positive organizational culture.' },
  { name: 'ICM', title: 'Information and Creative Media', image: '/division/icm.JPG', description: 'Manages digital communication, content creation, branding, and all media-related activities to project our image.' },
  { name: 'IR', title: 'Internal Relations', image: '/division/internal.JPG', description: 'Tasked with building strong internal connections, organizing member events, and ensuring smooth intra-divisional collaborations.' },
  { name: 'ER', title: 'External Relations', image: '/division/EXT.JPG', description: 'Handles external partnerships, public relations, networking with other organizations, and managing our external stakeholder interactions.' },
  { name: 'SAC', title: 'Student Academic & Competition', image: '/division/sac.JPG', description: 'Supports members in their academic pursuits and facilitates participation in various competitions to foster excellence.' },
  { name: 'SPT', title: 'Student Passions & Talents', image: '/division/spt.JPG', description: 'Nurtures individual creativity, hobbies, and talents by providing platforms and resources for members to explore their interests.' },
  { name: 'TECHNOPRENEUR', title: 'Technopreneur', image: '/division/Technoprenet.JPG', description: 'Drives entrepreneurship in technology and innovation, guiding members in developing tech-based business ideas.' }
];
...
<template>
  ...
  <div class="relative min-h-screen pt-16 bg-gradient-to-br from-white via-gray-50 to-slate-100">
    ...
    <section class="sticky z-20 py-6 border-t border-b border-gray-200 bg-white/70 backdrop-blur-sm top-16">
